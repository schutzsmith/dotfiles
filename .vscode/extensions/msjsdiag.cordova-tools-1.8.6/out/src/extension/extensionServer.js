...
class ExtensionServer {
    constructor(pluginSimulator, projectRoot) {
        ...
        this.messageHandlerDictionary[extensionMessaging_1.ExtensionMessage.GET_CORDOVA_EXECUTABLE] = this.getCordovaExecutable;
    }
    /**
     * Starts the server.
     */
    ...
    getCordovaExecutable(fsPath) {
        return Q.resolve(cordovaCommandHelper_1.CordovaCommandHelper.getCordovaExecutable(fsPath));
    }
}
