...
const qualityOfLife_1 = require("./features/qualityOfLife");
const Debug_1 = require("./utils/Debug");
function activate(context) {
    let qol = new qualityOfLife_1.default();
    ...
    let crane = new crane_1.default(langClient);
    context.subscriptions.push(vscode_1.commands.registerCommand("crane.reportBug", crane.reportBug));
    context.subscriptions.push(vscode_1.commands.registerCommand('crane.rebuildSources', () => {
        Debug_1.Debug.clear();
        Debug_1.Debug.info('Re-indexing PHP files in the workspace...');
        crane.rebuildProject();
    }));
    context.subscriptions.push(vscode_1.commands.registerCommand('crane.deleteCaches', () => {
        Debug_1.Debug.clear();
        Debug_1.Debug.info('Deleting all PHP caches....');
        crane.deleteCaches();
    }));
    context.subscriptions.push(vscode_1.commands.registerCommand('crane.downloadPHPLibraries', () => {
        Debug_1.Debug.clear();
