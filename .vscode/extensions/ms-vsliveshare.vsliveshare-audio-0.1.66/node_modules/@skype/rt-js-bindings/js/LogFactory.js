...
var LogFactoryImpl = (function (_super) {
    ...
    LogFactoryImpl.prototype.log = function (component, level, logId, fmt) {
        ...
        try {
            ...
            var log = LogFactory.instance().component('RootToolsManager.LogFactoryErrors');
            LogFactory.instance().declareComponentSafe('RootToolsManager.LogFactoryErrors', true);
            var args_len = ((typeof args) === 'object' && undefined !== args.length) ? args.length : "undefined";
            log.error("LogFactory logging failed %s: %s stack: %s args type: %s args_len: %s", e.name, e.message, e.stack, typeof args, args_len);
        }
    };
