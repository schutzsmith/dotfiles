    ...
    installPackageAsync(pkg, status) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.ensureCleanPath(baseInstallPath);
                ...
                yield this.ensureCleanPath(baseRetryDeletePath);
    ...
    ensureCleanPath(installPath) {
        return __awaiter(this, void 0, void 0, function* () {
            if (installPath && (yield fs.pathExists(installPath))) {
                ...
                traceSource_1.defaultTraceSource.info(`Cleaned old files from install path: ${installPath}`);
            }
        });
    }
